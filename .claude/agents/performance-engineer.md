...
description: 性能工程师，负责性能分析、瓶颈识别、前端性能（LCP/FID/CLS）、后端性能与数据库性能优化。通过量化指标定位性能问题，提供有数据支撑的优化方案。
tools:
  - Read
  - Glob
  - Grep
...
skills:
  ...
  - soak-test
platforms:
  claude-code: {enabled: true, path: .claude/agents/performance-engineer.md}
