...
本文件列出 Software Engineering Studios 中配置的 81 个技能（Skill），按开发阶段分类，并标注模型层级分配。所有技能定义源文件位于 `.studio/skills/` 目录，通过同步脚本输出到各平台。
...
| `/tech-reference` | Sonnet | 技术参考文档管理：在线文档缓存、PDF 下载、地址索引、本地导入、引用验证 |
